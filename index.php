...
<div id="landing_page">
    ...
    <div class="main-content">
        ...
        <?php } ?>
        <div class=" my-3">
            <h1 class="py-2">Bem-vindo ao centro de suporte da Catu!</h1>
            <h5>Aqui nossa equipe está de prontidão para atender sua solicitação.</h5>
        </div>
    </div>
    <div class="clear"></div>
    ...
    <img class="home-img d-none d-md-block" src="assets/catu-theme/home-img.png" alt="">
</div>
