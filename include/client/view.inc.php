...
<div class="d-flex flex-column flex-md-row">
    ...
    <div class="ml-md-auto mb-2 mb-md-0">
        <a class="action-button btn btn-outline-secondary btn-lg" href="tickets.php?a=print&id=<?php
        ...
        <?php if (
            ...
            <a class="action-button btn btn-outline-secondary btn-lg" href="tickets.php?a=edit&id=<?php
...
if ((!$ticket->isClosed() || $ticket->isReopenable()) && !$blockReply) { ?>
    <form id="reply" action="tickets.php?id=<?php echo $ticket->getId();
        ...
        <div>
            ...
            <textarea name="message" id="message" cols="50" rows="9" wrap="soft" class="<?php if ($cfg->isRichTextEnabled()) echo 'richtext';
                                                                                        ?> draft" <?php
        ...
        <p style="text-align:center">
            <input type="submit" class="btn btn-outline-secondary" value="<?php echo __('Post Reply'); ?>">
            <input type="reset" class="btn btn-outline-secondary" value="<?php echo __('Reset'); ?>">
            <input type="button" class="btn btn-outline-secondary" value="<?php echo __('Cancel'); ?>" onClick="history.go(-1)">
        </p>
    </form>
<?php
} ?>
