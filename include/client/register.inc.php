...
<form id="account" action="account.php" method="post">
    ...
    <div>
        ...
        <div class="form-group my-3">
            <label for=""><?php echo __('Time Zone'); ?>
            </label>
            <?php
            $TZ_NAME = 'timezone';
        ...
        <p style="text-align: center;">
            <input class="btn btn-outline-secondary" type="submit" value="<?php echo __('Register'); ?>" />
            <input class="btn btn-outline-danger" type="button" value="<?php echo __('Cancel'); ?>" onclick="javascript:
