...
<div class="search well">
    <div class="flush-left">
        <form class="form-inline" action="tickets.php" method="get" id="ticketSearchForm">
            ...
            <input type="text" class="form-control" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>">
            <input class="btn btn-outline-secondary ml-md-2 mt-2 mt-md-0" type="submit" value="<?php echo __('Search'); ?>">
            <div class="ml-auto form-group ">
                <label for="topic_id" class="mt-3 mt-md-0"><?php echo __('Help Topic'); ?></label>
                <select name="topic_id" class="nowarn custom-select ml-md-2" onchange="javascript: this.form.submit(); ">
...
<div class="d-flex">
    <a class="btn btn-outline-secondary btn-lg my-2" href="<?php echo Format::htmlchars($_SERVER['REQUEST_URI']); ?>"><i class="refresh icon-refresh"></i>
        <?php echo __('Tickets'); ?>
    </a>

    <div class="ml-auto states">
        <small>
            <?php if ($openTickets) { ?>
                <a class="btn btn-outline-secondary btn-lg my-2 state <?php if ($status == 'open') echo 'active'; ?>" href="?<?php echo Http::build_query(array('a' => 'search', 'status' => 'open')); ?>">
            ...
            if ($closedTickets) { ?>
                &nbsp;
                <a class="btn btn-outline-secondary btn-lg my-2 state <?php if ($status == 'closed') echo 'active'; ?>" href="?<?php echo Http::build_query(array('a' => 'search', 'status' => 'closed')); ?>">
