...
?>
<select name="<?php echo $TZ_NAME; ?>" id="timezone-dropdown" data-placeholder="<?php echo $TZ_PLACEHOLDER; ?>">
...
<br>
<button type="button" class="action-button btn btn-secondary my-1 mx-1" onclick="javascript:
